...
def pdb(input_set, mode):
    ...
    path_to_output_files, path_to_domains, fisher_path, path_to_interfaces, buffer =  manage_files(mode)
    ...
    if len(data) == 0:
        ...
        if len(to_swiss) != 0:
            ...
            swiss_model = pd.read_csv(path_to_output_files + '/swissmodel_structures/', sep='\t',
